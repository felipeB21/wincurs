...
export const metadata: Metadata = {
  ...
  applicationName: "Wincurs",
  description:
    "Discover and download the best custom cursors for Windows. Browse thousands of unique mouse pointers created by the community. Free download for Windows 10 and 11.",
  keywords: [
    "custom cursors",
    "windows cursors",
    "cursors",
